...
BOT_TOKEN = environ.get('BOT_TOKEN', "6456944981:AAE3jEy-n3awa3wv44RD3tNpwQ2OgosUjRU")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1216307744').split()]
auth_channel = environ.get('AUTH_CHANNEL','-1001394587233')
...
GRP_LNK = environ.get('GRP_LNK', 'netflixrequstgroup1')
